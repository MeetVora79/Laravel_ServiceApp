				...
				<div class="card">
					<div class="card-header  justify-content-between">
						...
						<div class="search-box form-inline search-element">
							<form action="{{ route('myallocation') }}" method="GET">
					...
					<div class="card-body p-0">
						<div class="table-responsive">
							<table class="table table-striped">
								<tr>
									<th scope="col"><a href="{{ route('myallocation', ['sort' => 'AllocationId', 'direction' => $nextDirection]) }}"><i class="fa fa-sort"></i></a>Allocation Id</th>
									<th scope="col"><a href="{{ route('myallocation', ['sort' => 'TicketId', 'direction' => $nextDirection]) }}"><i class="fa fa-sort"></i></a>Ticket Id</th>
									<th scope="col">Assign To</th>
									<th scope="col">Ticket Status</th>
									<th scope="col"><a href="{{ route('myallocation', ['sort' => 'ServiceDate', 'direction' => $nextDirection]) }}"><i class="fa fa-sort"></i></a>Service Date</th>
									<th scope="col"><a href="{{ route('myallocation', ['sort' => 'TimeSlot', 'direction' => $nextDirection]) }}"><i class="fa fa-sort"></i></a>Time Slot</th>
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		function clearAndRedirect() {
			...
			window.location.href = 'http://127.0.0.1:8000/tickets/myallocation/list';
		}
