                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('tickets.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row" id="uncheckedContent" >
                                ...
                                <div class="col-md-4">
                                  <select class="form-control @error('id') is-invalid @enderror select2 col-md-11" aria-label="Creater Name" id="TicketCreaterId" name="TicketCreaterId">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                  <input type="text" class="form-control @error('TicketSubject') is-invalid @enderror" id="TicketSubject" name="TicketSubject" value="{{ old('TicketSubject') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                  <select class="form-control @error('AssetId') is-invalid @enderror select2 col-md-11" aria-label="Assets" id="TicketAssetId" name="TicketAssetId" >
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                <select class="form-control @error('ticketpriority') is-invalid @enderror select2 col-md-11" aria-label="Priority" id="TicketPriorityId" name="TicketPriorityId" >
                                   <option>Select Priority </option>
                                    ...
                                    @if ($errors->has('ticketpriority'))
                                        <span class="text-danger">{{ $errors->first('ticketpriority') }}</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                  <input type="text" class="form-control @error('TicketDescription') is-invalid @enderror" id="TicketDescription" name="TicketDescription" value="{{ old('TicketDescription') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                  <input type="file" class="form-control @error('Attachments') is-invalid @enderror" id="Attachments " name="Attachments" value="{{ old('Attachments') }}">
