                ...
                <tr>
                  ...
                  <td>
                    <form action="{{ route('tickets.destroy', $ticket->TicketId) }}" method="post">
                      ...
                      <a href="{{ route('tickets.view', $ticket->TicketId) }}" class="btn btn-warning btn-sm m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Show"><i class="bi bi-eye"></i> </a>
