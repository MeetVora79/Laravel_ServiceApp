              ...
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="{{ route('maintenance.show', $asset->AssetId) }}" class="btn btn-warning btn-sm m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Show"><i class="bi bi-eye"></i> </a>
