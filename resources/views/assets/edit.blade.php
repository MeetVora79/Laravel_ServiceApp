                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('AssetName') is-invalid @enderror" id="AssetName" name="AssetName" value="{{ $asset->AssetName }}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('AssetSerialNum') is-invalid @enderror" id="AssetSerialNum" name="AssetSerialNum" value="{{ $asset->AssetSerialNum }}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('AssetDescription') is-invalid @enderror" id="AssetDescription" name="AssetDescription" value="{{ $asset->AssetDescription }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('AssetLocation') is-invalid @enderror" id="AssetLocation" name="AssetLocation" value="{{ $asset->AssetLocation }}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('AssetPurchaseDate') is-invalid @enderror" id="AssetPurchaseDate" name="AssetPurchaseDate" value="{{ $asset->AssetPurchaseDate }}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="date" class="form-control @error('AssetWarrantyExpiryDate') is-invalid @enderror" id="AssetWarrantyExpiryDate" name="AssetWarrantyExpiryDate" value="{{ $asset->AssetWarrantyExpiryDate }}">
