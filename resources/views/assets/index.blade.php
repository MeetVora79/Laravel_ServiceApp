          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-striped">
                <tr>
                  <th scope="col">Asset Id<a href="{{ route('assets.index', ['sort' => 'AssetId', 'direction' => $nextDirection]) }}"><i class="fa fa-sort"></i></a></th>
                  <th scope="col">Customer Name</th>
                  <th scope="col">Asset Name<a href="{{ route('assets.index', ['sort' => 'AssetName', 'direction' => $nextDirection]) }}"><i class="fa fa-sort"></i></a></th>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function clearAndRedirect() {
        ...
        window.location.href = 'http://127.0.0.1:8000/assets';
    }
